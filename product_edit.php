...
if(isset($_POST['product_update'])) {
										...
										$sql = "update products set product_name='$product_name' where product_id='$update_id'"; //Inserts data into the db, users table. Values correspond to fields
										
										$run_product = mysqli_query($connection, $sql); //(query variable , connection variable)
